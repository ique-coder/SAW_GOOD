...
<div id="content" class="p-4 p-md-5 pt-5">
	...
	<div class="container-fluid" style="padding-bottom: 40px" id="category">
		<div class="row">
			...
			<div class="col-sm-6 subcategory">
				<input type="radio" name="subcategory" id="agree" /> <label
	...
	<div class="container-fluid" style="margin-bottom: 30px;">
		<div class="col-sm-12">
				<form id="searchFrm" action="${path }/admin/auctionDisAgreeSearch" method="get">
	...
	<div class="container-fluid">
		<div style="text-align: right; padding-right: 20px;">
			<form action='${path }/admin/${keyword!=null?"auctionDisAgreeSearch":"auctionDisAgreeList"}' method="post" id="numFrm">
...
<script>
	...
	//한개승인
	$(".agreeAuc").click(function(){
		var val=$(this).val();
		location.replace("${path}/admin/agreeOneAuction?acno="+val);
		})
	//한개거부
	$(".disagreeAuc").click(function(){
		var val=$(this).val();
		location.replace("${path}/admin/disagreeOneAuction?acno="+val);
	})
	//선택승인
	$("#checkAgree").click(function(){
		$("#auctionFrm").attr("action","${path}/admin/checkAgreeAuction");
		$("#auctionFrm").submit();
	})
	//선택거부
	$("#checkDisagree").click(function(){
		$("#auctionFrm").attr("action","${path}/admin/checkDisgreeAuction")
		$("#auctionFrm").submit();
	})
	...
	$("#agree").click(function(){
		location.replace("${path}/admin/auctionAgreeList");
	})	
	//더블클릭 방지
	var click=false;
